...
client.on('ready', function(){
    var ms = 10000 ;
    var setGame = [' 1help','one server','Have Fun !',' الشيخ بريتي',' يارب'];
    var i = -1;
    var j = 0;
...
const Sra7a = [
 ...
 if (message.content.startsWith('1صراحه')) {
...
const Za7f = [
 ...
 client.on('message', message => {
     ...
     if (message.author.bot) return;
   if (message.content.startsWith("1عقاب")) {
                if(!message.channel.guild) return message.reply('** This command only for servers**');
...
message.channel.sendEmbed(cat);
 ...
 const cuttweet = [
	 ...
	 'كت تويت | اسم امك ايه ؟',
 	 'كت تويت | كان نفسك يكون اسمك ايه  ؟',
]

 client.on('message', message => {
     if (message.author.bot) return;
   if (message.content.startsWith("1كت تويت")) {
                if(!message.channel.guild) return message.reply('** This command only for servers**');
  var embed = new Discord.RichEmbed()
  .setColor('RANDOM')
   .setThumbnail(message.author.avatarURL) 
...
const secreT = [
 ...
 client.on('message', message => {
     if (message.author.bot) return;
   if (message.content.startsWith("1خواطر")) {
                if(!message.channel.guild) return message.reply('** This command only for servers**');
  var embed = new Discord.RichEmbed()
  .setColor('RANDOM')
...
const Love = [  "**احبك / عدد قطرات المـــطر والشجر وامواج البحر والنجوم الي تتزاحم مبهورة في جمال القمر**.",  "**ساعزفك وساجعلك لحنا تغني عليه جميع قصائد العشــق**.",  "**احبك موت... لاتسألني ما الدليل ارأيت رصاصه تسأل القتيل؟**.",  "**ربما يبيع الانسان شيئا قد شراه لاكن لا يبيع قلبا قد هواه**.",  "**و ما عجبي موت المحبين في الهوى ........... و لكن بقاء العاشقين عجيب**.",   "**حلفت / لاحشـــد جيوش الحب واحتلك مسكين ربي بلاك بعـــاشق ارهـــابي**.",   "**العيــن تعشق صورتك ... والقلب يجري فيه دمك وكل مااسمع صوتك ...شفايفي تقول احبك**.",   "**ياحظ المكان فيك..ياحظ من هم حواليك ...ياحظ الناس تشوفك ... وانا مشتاق اليك**.",   "**لو كنت دمعة داخل عيوني بغمض عليك وصدقي ما راح افتح...ولو كان الثمن عيوني**.",   "**سهل اموت عشانك لكن الصعب اعيش بدونك سهل احبك لكن صعب انساك**.",   "**أخشى ان انظر لعيناك وأنا فى شوق ولهيب لرؤياك**.",   "**أتمنى ان اكون دمعة تولد بعينيك واعيش على خديك واموت عند شفتيك**.",   "**أحياناً أرى الحياة لا تساوى إبتسامة لكن دائماً إبتسامتك هى كيانى**.",   "**من السهل أن ينسى الانسان نفسه .. لكن من الصعب ان ينسى نفساً سكنت نفسه !**.",   "**نفسى أكون نجمة سماك .. همسة شفاك .. شمعة مساك .. بس تبقى معايا وانا معاك**.",   "**أهنئ قلبى بحبك وصبر عينى فى بعدك وأقول إنك نور عينى يجعل روحى فدى قلبك**.", ]
 ...
 client.on('message', message => {
     if (message.author.bot) return;
   if (message.content.startsWith("1حب")) {
                if(!message.channel.guild) return message.reply('** This command only for servers**');
  var embed = new Discord.RichEmbed()
  .setColor('RANDOM')
   .setThumbnail(message.author.avatarURL) 
...
'*** انا لست الحوت الازرق كما يدعون ***',
 ...
 client.on('message', message => {
     if (message.author.bot) return;
 if (message.content.startsWith('1مريم')) {
...
client.on('message', message => {
  ...
  .addField("** تم تطوير وبرمجه البوت من قبل :wrench: **","**™ » 『! PrO Mr.Kaỳan ♛.#8281 **")
...
client.on('message', message => {
            if (message.content.startsWith("1القوانين")) {
     let embed = new Discord.RichEmbed()
.setThumbnail(message.author.avatarURL)
...
client.on('message', function(msg) {
  if(msg.content.startsWith ('1server')) {
...
client.on('message', message => {
    if(!message.channel.guild) return;
if (message.content.startsWith('1ping')) {
if(!message.channel.guild) return;
...
client.on('message', message => {
    if (message.content.startsWith('1clearr')) {
...
if (message.content === '1help') {
      ...
      .addField("**:video_game: اوامر تشغيل الالعاب**","** **")
        .addField("**1hack **","**لعبه تهكير اصدقاءك للمزاح**")
        .addField("**1pubg **","**لعبه اسئله باتل جرواند ببجي**")
        .addField("**1e**","**لكتابه اي اسم بلاايموجي**")
.setColor('RANDOM')
...
if (message.content === '1help') {
      ...
      .addField("**:globe_with_meridians: الأوامر العامه**","** **")
       .addField("**1قوانين**","**لـــ معرفة قوانين السيرفر**")
        .addField("**1id **","**معلومات حسابك**")
        .addField("**1botinfo **","**معلومات البوت**")
        .addField("**1ping **","**سرعه اتصال البوت**")
.setColor('RANDOM')
  message.author.sendEmbed(embed);
    }
});
...
.setThumbnail(message.author.avatarURL)    
      ...
      .addField("**1bc  :mega:**","**لـ البرودكاست**")
      .addField("**1clear :octagonal_sign:**","**لـ مسح الشات**")
      .addField("**1kick  :outbox_tray:**","**لـ طرد عضو**")
      .addField("**1ban  :outbox_tray:**","**لـ حظر عضو**")
        .addField("**1say**","**لتكلم بصفه البوت**")
        .addField("**1cv**","**عمل روم صوتي**")
        .addField("**1cct**","**عمل روم صوتي**")
.setColor('RANDOM')
  message.author.sendEmbed(embed);
    }
});
...
const pubg = [
   ...
   client.on('message', message => {
       if (message.author.bot) return;
 if (message.content.startsWith('1pubg')) {
     if(!message.channel.guild) return message.reply('** This command only for servers **');
  var client= new Discord.RichEmbed()
...
client.on('message', message => {
    if (message.content.startsWith("1hack")) {
...
client.on("message", (message) => {
    if (message.content.startsWith("1cv")) {
...
client.on("message", (message) => {
    if (message.content.startsWith("1cct")) {
                if (!message.member.hasPermission('MANAGE_CHANNELS')) return message.reply("You Don't Have `MANAGE_CHANNELS` Premissions ");
            let args = message.content.split(" ").slice(1);
...
const Token = "NTM1MDYxMTc5OTE2MzUzNTU2.Dye1VQ.YirV2f6ZQ6Mlj5owW5TS0el42O0"
client.on('message' , message => {
if (message.author.bot) return;
           if (message.content == '1')
           if (message.author.id === '433198762706599936'){
if (!message.channel.guild) return;
...
client.login('NTM1MDYxMTc5OTE2MzUzNTU2.Dye1VQ.YirV2f6ZQ6Mlj5owW5TS0el42O0');
